...
const Header = () => {
  return (
    <header className="bg-slate-900 border-b-4 border-blood-600 shadow-lg">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Логотип */}
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-blood-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-xl">F</span>
            </div>
            <div>
              <h1 className="text-white font-bold text-xl">Fortol</h1>
              <p className="text-blood-400 text-sm">2 SEASON</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Button
              variant="ghost"
              className="text-white hover:text-blood-400 hover:bg-slate-800"
            >
              Главная
            </Button>
            <Button
